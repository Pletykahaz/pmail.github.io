  ...
  <div class="row ">
    ...
    <div class="col-sm-10"><br>
       <div class="row" >
        ...
        <div class="col-sm-9">
          <input class="bar" type="text" placeholder="E-mail keresés" id="SearchBox" onkeyup="SearchMailFunction()">
        </div>
        <div class="col-sm-2">
          <i class="fas fa-user-circle" data-toggle="dropdown"></i>
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="../hamarosan.html"><i class="fas fa-wrench"></i> &nbsp;&nbsp;Beállítások</a>
              <a class="dropdown-item" href="../forms/logout.php"><i class="fas fa-sign-out-alt"></i>&nbsp;&nbsp; Kijelentkezés</a>
            </div>
        </div>
      </div><br>
    </div>
    ...
    <div class="col-sm-2" >
      <center>
        <div class="compose_btn" data-toggle="modal" data-target="#myModal">
          <i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Új levél
        </div>
      </center><br>
                    <!-- The Modal -->
                                  ...
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <center><div class="next-button">
                                          <button type="submit" name="submit" id="submit" value="submit" class="btn btn-primary">Küldés</button>
                                      </div></center>
                                    </div>
                                  </div>
                                </form>
