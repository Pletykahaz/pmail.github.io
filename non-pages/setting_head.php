...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" href="../mail">PletykaMail</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="index.php"><i class="fas fa-info-circle"></i>&nbsp;&nbsp;&nbsp;Rólunk</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="my_activities.php"><i class="fas fa-chart-line"></i>&nbsp;&nbsp;&nbsp;Aktivitások</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="recovery.php"><i class="fas fa-recycle"></i>&nbsp;&nbsp;&nbsp;Csatolás</a>
      </li> 
      <li class="nav-item">
        <a class="nav-link" href="theme.php"><i class="far fa-image"></i>&nbsp;&nbsp;&nbsp;Téma</a>
      </li> 
    </ul>
